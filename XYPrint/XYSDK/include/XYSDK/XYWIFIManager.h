...
@interface XYWIFIManager : NSObject
{
...
@property (nonatomic,weak) id<XYWIFIManagerDelegate> delegate;
// 连接回调
@property (nonatomic,copy) XYWIFIBlock callBack;
// 接收服务端返回的数据
@property (nonatomic,copy) XYWIFICallBackBlock callBackBlock;
...
// 发送XY完整指令
//- (void)XYWriteXYCommandWithData:(NSData *)data withResponse:(XYWIFICallBackBlock)block;
//#pragma mark - 打印机指令
//#pragma mark - ====================TSC指令===================
///**
// * 1.设置标签尺寸
