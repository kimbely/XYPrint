...
typedef void(^XYXYCompletionBlock)(CBCharacteristic *character);
typedef void(^XYTSCCompletionBlock)(CBCharacteristic *datcharacter);
...
@property (nonatomic,assign) id<XYBLEManagerDelegate> delegate;
/**
 *  指定写入数据的外设
 */
...
// * 输入XY指令
// */
//- (void)XYWriteXYCommondWithData:(NSData *)data callBack:(XYTSCCompletionBlock)block;
//#pragma mark - 其他方法
//#pragma mark - ====================XY指令====================
///**
// *1.水平定位
// */
//- (void)XYhorizontalXYition;
///**
// * 2.打印并换行
// */
//- (void)XYprintAndFeed;
...
// */
//- (void)XYUpdataPrinterState:(int)param completion:(XYXYCompletionBlock)callBlock;
///**
// * 6.实时对打印机请求
// * param : 表示对打印机发送的请求
// *  1 <= param <= 2
...
// * 范围：n  1,2,49,50
// */
//- (void)XYCallBackStatus:(int)n completion:(XYXYCompletionBlock)block;
///**
// * 62.打印光栅位图
// * 范围：m  0 - 3 或 48 - 51
//        xL 0 - 255
