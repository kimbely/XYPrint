...
在XprinterIosSdk的usr文件中，可见的头文件（.h文件）分别有：XYBLEManager.h,XYWIFIManager.h,TscCommand.h,XYCommand.h,ImageTranster.h和XYSDK.h.
 这几.h文件包含了蓝牙和wifi的连接：XYBLEMananger.h和XYWIFIManager，发送，接收数据的方法和需要遵循的代理，还有指令封装的工具类：TscCommand,XYCommand,图像处理类：ImageTranster;
 说明文档XYSDK.h
 XYBLEManager.h 是蓝牙管理类，处理蓝牙的连接相关和XY指令的发送。
 ...
 XYCommand.h,XY指令封装工具类，返回都是NSData类型。
