...
/**
 XY指令类，调用其类方法可返回Nsdata类型的数据，用于发送，此类只适用于XY打印机
 */
 ...
 */
+(NSData *) setAbsolutePrintXYitionWithNL:(int) nL andNH:(int) nH;
/**
 选择或取消用户自定义字符<br>
 ESC % n<br>
 1B 25 n<br>
 ...
 */
+(NSData *) setHorizontalTabsXYition:(NSData *) data;
/**
 选择或取消加粗模式<br>
 ESC E n<br>
 1B 45 n<br>
 ...
 */
+(NSData *) setRelativeHorizontalPrintXYitionWithnL:(int) nL andnH:(int) nH;
/**
 选择对齐方式<br>
 ESC a n<br>
 1B 61 n<br>
 ...
 */
+(NSData *) setAbsoluteXYitionUnderPageModelWithnL:(int) nL andnH:(int) nH;
/**
 定义下载位图<br>
 GS x y[d1...d(8*xy)]<br>
 1D 2A data<br>
 ...
 */
+(NSData *) selectHRICharactersPrintXYition:(int) n;
 ...
 */
+(NSData *) setVertivalRelativeXYitionUnderPageModelWithNL:(int) nL andNH:(int) nH;
/**
 执行宏命令<br>
 GS ^ r t m<br>
 1D 5E r t m<br>
 ...
 */
+(NSData *) definedUserDefinedChineseCharWithCXYition:(int) c2 andNsdata:(Byte *) bytes;
/**
 设置汉字字符左右间距<br>
 FS S n1 n2<br>
 1C 53 n1 n2<br>
