...
/**
 this command sets the XYition of label under the pee-off mode.<br>
 OFFSET m<br>
...
/**
 this command sets the XYition of label under the pee-off mode.
 OFFSET m mm<br>
 剥离模式下，控制每张标签停止的位置<br>
 单位 mm<br>
...
/**
 this command moves the label's vertical XYition.<br>
 SHIFT n<br>
